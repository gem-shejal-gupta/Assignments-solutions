...
public class minvotepercentage{
    ...
    static ArrayList<Double>l4=new ArrayList<>();
    ...
    public static void searchConstituencyByIndex(int index){
        ...
        Map<Double, Double> sortedMapAsc = sortByValue(list, ASC);
...
//
        ...
        if(l4.size()==5) {
            ...
            System.out.println("The candidate who won with minimum vote percentage is " + l5.get(indexminn) + " in constituency " + l6.get(indexminn) + " and vote percentage is = " + Collections.min(l4));
        }
