...
//name of candidate
        ...
        if(l1.size()==cs.size()-1) {
            ...
            System.out.println("The candidate who won with minimum vote is "+ l2.get(indexmin)+" in constituency "+l3.get(indexmin)+ " and vote is = " + Collections.min(l1));
        }
