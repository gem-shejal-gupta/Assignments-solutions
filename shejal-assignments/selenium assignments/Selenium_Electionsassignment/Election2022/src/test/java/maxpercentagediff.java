...
public class maxpercentagediff {
    ...
    static ArrayList<Double> l2 = new ArrayList<>();
    static ArrayList<Double> l3 = new ArrayList<>();
    ...
    public static void searchConstituencyByIndex ( int index){
        ...
        double row = Votes.indexOf(obj) + 4;
        Collections.sort(Votes);
        double obj2 = Votes.get(Votes.size() - 2);
        l3.add(obj - obj2);
...
//               System.out.println(name);
            ...
            System.out.println("The candidate who won with maximum vote percentage difference is :  " + name.get(maxindex) + "  with vote percentage difference of : " + Collections.max(l3) + "  in constituency :" + consituency.get(maxindex));
            l3.clear();
            Votes.clear();
            name.clear();
            consituency.clear();
