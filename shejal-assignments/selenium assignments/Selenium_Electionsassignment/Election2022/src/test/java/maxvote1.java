...
public class maxvote1 {
    ...
    public static void searchConstituencyByIndex(int index){
        ...
        Map<Integer, Integer> sortedMapAsc = sortByValue(list, DSc);
...
//name of candidate
      ...
      // System.out.println("---" + nameOfCandidate);
        if(l1.size()==cs.size()-1) {
            ...
            System.out.println("The candidate who won with Highest vote is "+ l2.get(indexmax)+" in constituency "+l3.get(indexmax)+ " and vote is = " + Collections.max(l1));
        }
